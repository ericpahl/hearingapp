...
1.1 Log in
When the app is opened for the first time, the user will be asked to log in with a google account. 
On a device or emulator, the user will be redirected to an in-app browser to log in. On the Chrome browser, a pop up window will appear and ask the user to log in.
...
Tapping the play button will play a random sequence of 3 digits (not zero or seven). 
The user can guess the digits by entering a number in each of the inputs below the play button and pressing submit. 
If the user is correct, the next sequence will be quieter. 
If the user is incorrect, the next sequence will be louder. This will continue for 24 sequences.
